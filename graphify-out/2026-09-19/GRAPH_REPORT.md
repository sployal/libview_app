...
Cohesion: 0.02
Nodes (110): browse_documents.dart, _addTodo, _bootstrapHome, build, _buildCalendar, _buildCalendarDay, _buildHeader, _buildRecentRow (+102 more)
...
### Community 31 - "State"
Cohesion: 0.08
Nodes (35): OnboardingScreen, _OnboardingScreenState, _LocalDocPreview, _LocalDocPreviewState, ClientFilesBrowserScreen, _ClientFilesBrowserScreenState, _AddToPlaylistSheet, _AddToPlaylistSheetState (+27 more)
...
Cohesion: 0.06
Nodes (34): dart:ui, _artworkFor, _askedPermission, _bufferedPosition, _configureAudioSession, _ensureAndroidNotificationPermission, ensureInitialized, _fallbackArt (+26 more)
...
Cohesion: 0.13
Nodes (14): BoxFit, Future, build, createState, didUpdateWidget, fallback, fileId, fit (+6 more)
...
Cohesion: 0.29
Nodes (8): MainScreen, _MainScreenState, AppUpdateGate, _AppUpdateGateState, HomeScreen, _HomeScreenState, TickerProviderStateMixin, WidgetsBindingObserver
...
### Community 122 - "SingleTickerProviderStateMixin"
Cohesion: 0.18
...
### Community 124 - "PlaybackAudioHandler"
Cohesion: 0.67
Nodes (3): BaseAudioHandler, PlaybackAudioHandler, SeekHandler

## Knowledge Gaps
- **2983 isolated node(s):** `axios`, `path`, `MONTH_NAMES`, `{ google }`, `recentByIp` (+2978 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 3161 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
